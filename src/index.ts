...
export const getMaskFromObject = (object: IObject, level = Infinity): string[] => {
  const result: string[] = []
...
export const filterMaskByObject = (mask: string[], object: IObject): string[] => {
...
export const getObjectByMask = (object: IObject, mask: string[]): IObject => {
...
export const updateObjectByMask = (target: IObject, update: IObject, mask: string[]): number => {
